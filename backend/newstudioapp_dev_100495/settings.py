"""
Django settings for newstudioapp_dev_100495 project.
...
ROOT_URLCONF = 'newstudioapp_dev_100495.urls'
...
WSGI_APPLICATION = 'newstudioapp_dev_100495.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newstudioapp_dev_100495 API",
    "DESCRIPTION": "API documentation for newstudioapp_dev_100495 App",
    "VERSION": "v1",
}
